...
| R432 | R439 | Bloc 62 — offboarding = workflow du moteur | OF-01..03, OF-10 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R433 | R440 | Bloc 62 — health check guards, sévérité tenant | OF-04..05, OF-12..14 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R434 | R441 | Bloc 62 — chaîne d'approbation par niveau + forçage | OF-06..08 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R435 | R442 | Bloc 62 — motifs & initiateurs tenant | OF-01..02 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R436 | R443 | Bloc 62 — checklists tenant versionnées | OF-09 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R437 | R444 | Bloc 62 — clôturé rejouable + rétention | OF-10..11 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R438 | R445 | Bloc 62 — pop-up d'engagement paramétrage | OF-13 | `spec/BLOC-62-OFFBOARDING-R432-R438.md` |
| R439 | R446 | Bloc 63 — demande de business trip = workflow du moteur | BT-01..03, BT-09 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R440 | R447 | Bloc 63 — guards pré-départ, sévérités tenant | BT-04..08, BT-12 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R441 | R448 | Bloc 63 — check pré-voyage figé avec version de matrice | BT-06..07, BT-14 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R442 | R449 | Bloc 63 — quotas jours bancables + overrides RM | BT-05, BT-15 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R443 | R450 | Bloc 63 — certificat de trip (clôture du voyage) | BT-10..12 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R444 | R451 | Bloc 63 — croisement formation × activité (MOD-43 fait foi) | BT-04 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R445 | R452 | Bloc 63 — §BusinessTrip R-Q + pop-up généralisé (R445 repo) | BT-13 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R458 | R465 | Bloc 63 — prospect né en voyage (ajout d'audit) | BT-16 | `spec/BLOC-63-BUSINESS-TRIP-R446-R452-R465.md` |
| R459 | R466 | Bloc 65 — KYC/AR/GAR trois TYPES du même dossier | HR-01, HR-12 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R460 | R467 | Bloc 65 — l'AR part du dernier KYC approuvé, revue = DIFF visé | HR-02..03 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R461 | R468 | Bloc 65 — verdict normalisé, conséquences proposées (R44) | HR-04..05 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R462 | R469 | Bloc 65 — groupe = référentiel paramétrable, composition projetée | HR-06 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R463 | R470 | Bloc 65 — GAR = dossier PARENT lié aux membres | HR-07..09 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R464 | R471 | Bloc 65 — cascades = ÉVÉNEMENTS du moteur, anti-boucle | HR-10..11 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R465 | R472 | Bloc 65 — une interface, une couche de définition | HR-13..14 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R466 | R473 | Bloc 65 — §Review unifié (R-Q + pop-up R445) | HR-05..06, HR-11 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R467 | R474 | Bloc 65 — décision d'étape uniforme (3 issues + déléguer) | HR-15 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R468 | R475 | Bloc 65 — renvoi ciblé tracé, jamais une gomme | HR-16..18 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R469 | R476 | Bloc 65 — refus motivé, issue paramétrée par étape | HR-17, HR-19 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R470 | R477 | Bloc 65 — fluidité : décider ne coûte qu'un geste (optimiste honnête) | HR-20 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R471 | R478 | Bloc 65 — corbeille unifiée « À décider » | HR-21 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R472 | R479 | Bloc 65 — après la décision : SUIVANT/RESTER, annulation réversible | HR-22 | `spec/BLOC-65-REVUES-R466-R479.md` |
| R446 | R453 | Bloc 64 — matrice cross-border = PORT versionné (extension R293) | XB-01..02, XB-14 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R447 | R454 | Bloc 64 — actes cross-border distants (2e surface R294 étendue) | XB-03..04 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R448 | R455 | Bloc 64 — check pré-acte embarqué (MKT/ADVICE/ORDER, R295) | XB-05 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R449 | R456 | Bloc 64 — registre reverse solicitation (objet de preuve) | XB-06..07 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R450 | R457 | Bloc 64 — localisation temporaire prime le domicile | XB-08 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R451 | R458 | Bloc 64 — certification par juridiction (codes XB-<pays>, MOD-43) | XB-09 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R452 | R459 | Bloc 64 — analyse d'impact sur changement de matrice | XB-10 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R453 | R460 | Bloc 64 — exposition cross-border = projection consolidée | XB-11 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R454 | R461 | Bloc 64 — régime par entité de booking | XB-12 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R455 | R462 | Bloc 64 — §CrossBorder R-Q + pop-up (R445 repo généralisé) | XB-13 | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R456 | R463 | Bloc 64 — [OLIVIA GELÉE] briefing pack pré-voyage | — | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
| R457 | R464 | Bloc 64 — [OLIVIA GELÉE] rapprochement certificat de trip | — | `spec/BLOC-64-CROSS-BORDER-R453-R464.md` |
...
| Session | Repo | Nature |
|---------|------|--------|
| R332–R334 (On-premise PK-01..06) | **réservé R418+** | L'On-premise packaging (paquet signé autosuffisant) **n'est pas implémenté** au repo. Son créneau présumé (R335–R337 par le décalage +3) a été **réattribué à la robustesse** : R335=RB, R336=LK, R337=IDM, R338=PJ, R339=EV. **DÉCISION Ali (2026-07-29) : PK renuméroté > R339.** **Step-0 (2026-08-04, §4) — révisé par le drop PO `SESSION-2026-08-04.md` : R340–R377 = AML Gap Wave 1, R378–R403 = AML Gap Wave 2 (26 règles, blocs 57–61), R404 = FilterBar (R-FB). La réservation PK (non implémentée) glisse donc à R405+** (même règle que le déplacement R335→R340 : l'implémenté/ratifié prend le créneau contigu, la réservation glisse). **Mise à jour 2026-08-05 : le moteur de screening configurable multi-méthodes est implémenté et ratifié à R405–R417 (voir ligne suivante) ; la réservation PK glisse encore, à R418+** (même règle). **Mise à jour 2026-08-08 : le bloc WD (Workflow Designer) est ratifié à R432–R438 et le Bloc 62 Offboarding (session R432–R438) à R439–R445 — la réservation PK glisse à R446+** (même règle). **Mise à jour 2026-08-08 (session Blocs 63/64) : Bloc 63 Business Trip (session R439–R445+R458) ratifié à R446–R452+R465 et Bloc 64 Cross-Border (session R446–R457) à R453–R464 (R463/R464 GELÉES, Olivia) — la réservation PK glisse à R466+** (même règle). **Mise à jour 2026-08-09 (Bloc 65 Harmonisation des revues) : session R459–R472 attribuée à R466–R479 (arbitrage PO 09.08) — la réservation PK glisse à R480+** (même règle). **Mise à jour 2026-08-10 (V2-M7 ETL core banking) : la spec `spec/ETL-CORE-BANKING-R480-R489-PROPOSITION.md` est ARBITRÉE par le PO (Q1–Q5, 10.08.2026) et sa numérotation R480–R489 RATIFIÉE (Q5) — la réservation PK glisse à R490+** (même règle). **Mise à jour 2026-08-12 (V2-M43 calendrier réglementaire) : `spec/CALENDRIER-REGLEMENTAIRE-R490-R492.md` prend R490–R492 (implémenté, gardé CR-01..10, registre des règles vert) — la réservation PK glisse à R493+** (même règle : l'implémenté prend le créneau contigu, la réservation glisse). Réservation notée ici jusqu'à la spec PK. |
