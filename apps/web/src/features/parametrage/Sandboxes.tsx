...
function Bac({ titre, sousTitre, leviers, action, pont }: {
  ...
  return <div style={{ padding: 12, marginBottom: 14, borderRadius: tokens.radius.lg,
...
export function Sandboxes() {
  return <div>
    ...
    <Bac titre="sbkyc" sousTitre="Levier : un droit REQUIRED ajouté (rôle × section) → dossiers devenant incomplets + charge par rôle (BS-03)"
    ...
    <Bac titre="sbbrm" sousTitre="Levier : seuils de la grille SDD/CDD/EDD → reclassements NOMINATIFS + Δ charge EDD (BS-04)"
    ...
    <Bac titre="sbcf" sousTitre="Levier : exigences documentaires par structure → non-conformités et manquants PAR DOSSIER"
    ...
    <Bac titre="sbwf" sousTitre="Levier : délais cibles par section → goulots projetés + charge par rôle"
