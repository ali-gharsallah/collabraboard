...
export function Router() {
  ...
  return <div style={{ fontFamily: "system-ui", padding: 24, maxWidth: 1100, margin: "0 auto" }}>
    <div style={{ display: "flex", gap: 6, marginBottom: 18, flexWrap: "wrap" }}>
      {tab("home", "Accueil")}{tab("command", "Command Center")}{tab("compliance", "Compliance Center")}{tab("dashboard", "Dashboard")}{tab("clients", "Clients")}{tab("onboarding", "Onboarding")}{tab("prospection", "Pré-prospection")}{tab("kyc", "KYC")}{tab("screening", "Screening")}{tab("screeningadv", "Screening avancé")}{tab("alertes", "File d'alertes")}{tab("dossiers", "Dossiers de risque")}{tab("review", "Account Review")}{tab("ubo", "Personnes / UBO")}{tab("coc", "Chgt circonstances")}{tab("transactions", "Transferts & ordres")}{tab("settlement", "Settlement")}{tab("mros", "Reporting MROS")}{tab("ged", "Pièces (GED)")}{tab("gedcoffre", "GED / coffre")}{tab("registrelba", "Registre LBA")}{tab("crm", "CRM Banque")}{tab("contactreports", "Contact Reports")}{tab("workflow", "Workflow")}{tab("corroboration", "Corroboration")}{tab("parametrage", "Paramétrage")}{tab("golive", "Config & Go-live")}{tab("pms", "PMS")}{tab("amlref", "Référentiel AML")}{tab("sbaml", "Bac à sable AML")}{tab("sbonb", "Bac à sable Onboarding")}{tab("ports", "Ports")}{tab("integrations", "Intégrations")}{tab("nba", "Next Best Action")}{tab("wfi", "Workflow Instances")}{tab("tasks", "Tâches")}{tab("formations", "Formations")}{tab("trips", "Business Trip")}{tab("crossborder", "Cross-border")}{tab("rejeu", "Rejeu KYC à date")}{tab("aml", "Règles AML")}{tab("islamic", "Finance Islamique")}{tab("cpsiProfil", "CPSI · Profil")}{tab("cpsiSeg", "CPSI · Segmentation")}{tab("cpsiCases", "CPSI · Risk cases")}{tab("cpsiParam", "CPSI · Barèmes")}{tab("cpsiGuide", "CPSI · Guide")}{tab("offboarding", "Offboarding")}{tab("olivia", "Olivia")}{tab("oliviaruns", "Olivia · Runs")}{tab("amlws", "AML Workspace")}{tab("sdkyc", "Sections & droits")}{tab("sdar", "Profils AR")}{tab("sdgar", "Profils GAR")}{tab("paramfields", "Registre paramètres")}{tab("cocparam", "Types de CoC")}{tab("sandboxes", "Bacs à sable")}{tab("audit", "Audit & transport")}{tab("auditit", "Audit IT")}{tab("paramnav", "Utilisateurs & rôles")}{tab("iamguide", "Guide IAM")}{tab("ssoparam", "SSO / Fédération")}
    </div>
