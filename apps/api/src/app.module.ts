...
import { ReadinessModule } from "./modules/readiness/readiness.module"; // R330 : readiness & pipeline (vague de clôture)
...
import { RapportsModule } from "./modules/rapports/rapports.module";   // R50 : exports réglementaires
