...
| R26 | calcul | Résolution des documents requis | `kyc/docmatrix.service.ts` (matrice documentaire — axe **rôle** ajouté au contrat le 12.08.2026, `parRole` ; jusque-là l'énoncé promettait un croisement que le code ne faisait pas : cf. E-V2-9) | **OUI** — « Les documents requis se déduisent du croisement type d'entité × juridiction × rôle. » | **CDB 20** (identification) |
