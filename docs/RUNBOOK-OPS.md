...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **319 verts** (… + OCR typé OC-01..06 R174→R176 + Licence vendor LC-01..05 R177→R179 + Port GED externe GX-01..05 R180→R182 + Capacité d'équipe WK-01..05 R183→R185 depuis le lot 39 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (319), e2e (6/6),
