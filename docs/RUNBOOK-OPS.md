...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **279 verts** (… + Annotations AN-01..06 R156→R159 + Chaînes de câblage CB-01..06 (clauses R144/R148/R151) + IA au service du dossier AI-01..06 R160→R163 + Dossiers-vues VU-01..05 R164→R166 depuis le lot 32 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (279), e2e (6/6),
