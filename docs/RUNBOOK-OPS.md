...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **274 verts** (… + Personnes liées PL-01..04 R152→R155 + Annotations AN-01..06 R156→R159 + Chaînes de câblage CB-01..06 (clauses R144/R148/R151) + IA au service du dossier AI-01..06 R160→R163 depuis le lot 31 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (274), e2e (6/6),
