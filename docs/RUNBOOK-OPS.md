...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **256 verts** (… + Portail TX R140→R143 + Coffre CV-01..06 R144→R147 + Recherche RS-01..06 R148→R151 + Personnes liées PL-01..04 R152→R155 depuis le bloc 28 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (256), e2e (6/6),
