...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **250 verts** (… + Ingestion GED IG R137→R139 + Portail TX R140→R143 + Coffre CV-01..06 R144→R147 + Recherche RS-01..06 R148→R151 depuis le bloc 27 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (250), e2e (6/6),
