...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **288 verts** (… + IA au service du dossier AI-01..06 R160→R163 + Dossiers-vues VU-01..05 R164→R166 + Core banking en port SY-01..05 R167→R169 + Rétention au classement RN-01..04 R170 depuis le lot 33 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (288), e2e (6/6),
