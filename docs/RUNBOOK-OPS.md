...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **262 verts** (… + Coffre CV-01..06 R144→R147 + Recherche RS-01..06 R148→R151 + Personnes liées PL-01..04 R152→R155 + Annotations AN-01..06 R156→R159 depuis le bloc 29 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (262), e2e (6/6),
