...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **293 verts** (… + Dossiers-vues VU-01..05 R164→R166 + Core banking en port SY-01..05 R167→R169 + Rétention au classement RN-01..04 R170 + Workflow gouverné WF-01..05 R171→R173 depuis le lot 34 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (293), e2e (6/6),
