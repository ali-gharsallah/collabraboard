...
| 3. Règles + IAM + corpus session | `npm run test:rules` | **202 verts** (… + Onboarding OB R117→R120 + Pré-revue IA AG-01..06 R121→R124 depuis le bloc 20 ; cf. `docs/verify-run-2026-07-19.txt`) |
...
(plus aucun advisory) : lint + typecheck, `prisma:post`, `test:rules` (202), e2e (6/6),
