...
| **Intégration (e2e)** | Prouver la pile réelle (NestFactory + **Postgres réel** + RLS) | `test:e2e` (`kyc-rules` + `fat-vague1..17` + A3) | **84 tests, 17 suites** |
...
- **0 régression** : 425 règles + 84 e2e + 13 Vitest verts.
